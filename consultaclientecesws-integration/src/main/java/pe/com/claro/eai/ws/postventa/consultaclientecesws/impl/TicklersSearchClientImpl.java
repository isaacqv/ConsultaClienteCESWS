...
import pe.com.claro.eai.ws.postventa.consultaclientecesws.client.interfaz.TicklersSearchClient;
...
@Service
public class TicklersSearchClientImpl implements TicklersSearchClient {

	private static final Logger logger = Logger.getLogger(TicklersSearchClientImpl.class);
